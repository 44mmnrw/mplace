...
--
-- Table structure for table `author_addresses`
--
...
--
-- Dumping data for table `author_addresses`
--

LOCK TABLES `author_addresses` WRITE;
/*!40000 ALTER TABLE `author_addresses` DISABLE KEYS */;
/*!40000 ALTER TABLE `author_addresses` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `author_tax_info`
--
...
--
-- Dumping data for table `author_tax_info`
--

LOCK TABLES `author_tax_info` WRITE;
/*!40000 ALTER TABLE `author_tax_info` DISABLE KEYS */;
/*!40000 ALTER TABLE `author_tax_info` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Профили авторов мастер-классов. Продают напрямую без магазина';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `authors` VALUES (2,2,'Юрий Гагарин','iurii-gagarin-2',NULL,NULL,0,0.00,0,0,1,'2026-02-06 04:46:57','2026-02-06 04:46:57',NULL);
...
) ENGINE=InnoDB AUTO_INCREMENT=7 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Иерархические категории товаров. Поддержка множественных родителей';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `categories` VALUES (1,'Пэчворк','patchwork',NULL,NULL,NULL,NULL,1,1,NULL,NULL,NULL,'2026-02-04 10:22:38','2026-02-04 10:22:38',NULL),(2,'Вязание','viazanie',NULL,NULL,NULL,NULL,2,1,NULL,NULL,NULL,'2026-02-04 10:22:38','2026-02-04 10:22:38',NULL),(3,'Шитье','sewing',NULL,NULL,NULL,NULL,3,1,NULL,NULL,NULL,'2026-02-04 10:22:38','2026-02-04 10:22:38',NULL),(4,'Вышивка','vysivka',NULL,NULL,NULL,NULL,4,1,NULL,NULL,NULL,'2026-02-04 10:22:38','2026-02-04 10:22:38',NULL),(5,'Скрапбукинг','srapbooking',NULL,NULL,NULL,NULL,5,1,NULL,NULL,NULL,'2026-02-04 10:22:38','2026-02-04 10:22:38',NULL),(6,'Мыловарение','soap_making',NULL,NULL,NULL,NULL,6,1,NULL,NULL,NULL,'2026-02-04 10:22:38','2026-02-04 10:22:38',NULL);
...
LOCK TABLES `category_relations` WRITE;
/*!40000 ALTER TABLE `category_relations` DISABLE KEYS */;
/*!40000 ALTER TABLE `category_relations` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `migrations` (
  ...
  `batch` int NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='История выполненных миграций Laravel';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `migrations` VALUES (1,'2024_02_04_000001_create_shops_table',1),(2,'2024_02_04_000002_update_products_add_shop_id',1),(3,'2024_02_04_000003_update_shops_change_user_to_author',2);
...
--
-- Table structure for table `npd_receipts`
--
...
--
-- Dumping data for table `npd_receipts`
--

LOCK TABLES `npd_receipts` WRITE;
/*!40000 ALTER TABLE `npd_receipts` DISABLE KEYS */;
/*!40000 ALTER TABLE `npd_receipts` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `order_item_access`
--
...
--
-- Dumping data for table `order_item_access`
--

LOCK TABLES `order_item_access` WRITE;
/*!40000 ALTER TABLE `order_item_access` DISABLE KEYS */;
/*!40000 ALTER TABLE `order_item_access` ENABLE KEYS */;
UNLOCK TABLES;
...
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='История цен с temporal validity (valid_from/valid_to)';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `product_prices` VALUES (1,3,2990.00,NULL,'RUB',NULL,NULL,1,NULL,'2026-02-06 04:51:25','2026-02-06 04:51:25');
...
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Мастер-классы и цифровые товары. SKU артикул. shop_id или author_id';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `products` VALUES (3,1,'Тестовый Мастер Класс','testovyi-master-klass',NULL,'','',0,NULL,6,NULL,'video','ru','draft',1,0,NULL,NULL,NULL,0,0,0.00,0,1,NULL,NULL,NULL,NULL,'2026-02-06 04:51:25','2026-02-06 04:51:25',NULL);
...
LOCK TABLES `seller_balances` WRITE;
/*!40000 ALTER TABLE `seller_balances` DISABLE KEYS */;
/*!40000 ALTER TABLE `seller_balances` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `sessions` VALUES ('iIuOYfgidBqp0fiSk5mzBoP1PO6c6PHtjwwRgwzq',2,'127.0.0.1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/144.0.0.0 Safari/537.36','',1770364294),('n1vFFcZxs0Eh16wDwHcO2z1WwBFu3Blz7yZxVmzG',NULL,'::1','Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Code/1.108.2 Chrome/142.0.7444.235 Electron/39.2.7 Safari/537.36','',1770362639);
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Базовая таблица пользователей Laravel';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `users` VALUES (2,'Юрий','Гагарин','insight.yr@gmail.com',NULL,NULL,NULL,'$2y$12$kKrt5JKtPELJOHdTn2D7ruSeKT8tGCAPkC897ER0jrKrlVHloVS9m',NULL,'2026-02-06 04:46:57','2026-02-06 04:46:57');
...
-- Dump completed on 2026-02-06 10:54:25
